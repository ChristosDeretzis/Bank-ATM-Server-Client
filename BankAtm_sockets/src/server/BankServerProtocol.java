...
public class BankServerProtocol {
    ...
    // This function initializes the connections with the database
    // in order to fetch data from our database
    ...
    // of the user
    public String process_request(String input_message) throws SQLException {
