...
public class BankServerImplementation extends UnicastRemoteObject implements BankServer {
    // Initialize all of the parameters for the database connection
    private static final String DRIVER_NAME = "com.mysql.jdbc.Driver";
    private static final String URL = "jdbc:mysql://localhost:3306/bankatm?autoReconnect=true";
    ...
    // Implementation of the method from BankServer Interface
    // This function receives the message from the client and returns a
    // personalised message to the server based on the success or the failure
    // of the user
    public String process_request(String input_message) throws SQLException, RemoteException {
