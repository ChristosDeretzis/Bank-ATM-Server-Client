...
public class BankClient {
    private HelperFunctions protocol;
    private BankServer bankServer;

    private Scanner scanner = new Scanner(System.in);

    public BankClient(BankServer bankServer) throws IOException {
        this.bankServer = bankServer;
    }

    public void run_client() throws IOException, SQLException {
        ...
        while (true){
            ...
            result_from_server = bankServer.process_request(message_to_server);
